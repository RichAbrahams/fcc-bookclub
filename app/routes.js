  ...
  return [
    {
      ...
      getComponent(nextState, cb) {
        const importModules = Promise.all([
          import('containers/MyTrades/reducer'),
          import('containers/MyTrades/sagas'),
          import('containers/MyTrades'),
        ]);

        const renderRoute = loadModule(cb);

        importModules.then(([reducer, sagas, component]) => {
          injectReducer('myTrades', reducer.default);
          injectSagas(sagas.default);
          renderRoute(component);
        });
      ...
      getComponent(nextState, cb) {
        const importModules = Promise.all([
          import('containers/MyBooks/reducer'),
          import('containers/MyBooks/sagas'),
          import('containers/MyBooks'),
        ]);

        const renderRoute = loadModule(cb);

        importModules.then(([reducer, sagas, component]) => {
          injectReducer('myBooks', reducer.default);
          injectSagas(sagas.default);
          renderRoute(component);
        });
